...
<div class="row" style="margin-left: 50px; margin-right: 50px">
  ...
  <div class="col-lg-3">
    ...
    <div class="middle">
      <div class="text"><button type="button" class="btn btn-secondary"><a style="color:white;text-decoration: none;" href="{{ route('themgiohang',$sp_th->id) }}"><i class="fas fa-cart-plus"></i>&nbsp;giỏ hàng</a></button></div>
    </div>
