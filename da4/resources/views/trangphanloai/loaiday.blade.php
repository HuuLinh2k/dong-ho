...
<div style="width: 100%; height: 65px; background-color: #ECE7E7">
  ...
  <div class="row" style="margin-left: 50px; margin-right: 50px">
    ...
    <div class="col-lg-3">
     ...
     <div class="middle">
    <div class="text"><button type="button" class="btn btn-secondary"><a style="color:white;text-decoration: none;" href="{{ route('themgiohang',$sp_day->id) }}"><i class="fas fa-cart-plus"></i>&nbsp;giỏ hàng</a></button></div>
  </div>
