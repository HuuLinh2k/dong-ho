...
<div id="myCarousel" class="carousel slide" data-ride="carousel" s>
 ...
 <div class="carousel-inner">
  <div class="carousel-item active">
    <img src="public\image\slide1\sl.png" alt="Los Angeles" width="100%" height="400px">
  </div>
  @foreach($slide as $sl)
...
<div class="row" style="margin-right: 50px; margin-left: 50px" id="banchay1">
 ...
 <div class="col-lg-3">
  ...
  <div class="middle">
    <div class="text"><button type="button" class="btn btn-secondary"><a style="color:white;text-decoration: none;" href="{{ route('themgiohang',$bc->id) }}"><i class="fas fa-cart-plus"></i>&nbsp;giỏ hàng</a></button></div>
  </div
...
<div class="row" style="margin-right: 50px; margin-left: 50px" id="dhnu">
  ...
  <div class="col-lg-3">
   ...
   <div class="middle">
    <div class="text"><button type="button" class="btn btn-secondary"><a style="color:white;text-decoration: none;" href="{{ route('themgiohang',$nu->id) }}"><i class="fas fa-cart-plus"></i>&nbsp;giỏ hàng</a></button></div>
  </div>
...
<div class="row" style="margin-right: 50px; margin-left: 50px">
  ...
  <div class="col-lg-3">
    ...
    <div class="middle">
      <div class="text"><button type="button" class="btn btn-secondary"><a style="color:white;text-decoration: none;" href="{{ route('themgiohang',$nam->id) }}"><i class="fas fa-cart-plus"></i>&nbsp;giỏ hàng</a></button></div>
    </div>
    <p style="font-size: 14px;text-align: center; margin-left: 100px;margin-top: 10px ">
...
<br><br>
<div>
 <h2 style="text-align: center;margin-top: 30px; color: orange; font-family: cursive;">Tin Tức</h2>
 <hr width="80%">
 <br>
</div>
<div class="container">
